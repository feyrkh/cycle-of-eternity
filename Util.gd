...
const statsMetadata = {
	...
	"b_recover": {"name":"Body recovery", "desc":"How quickly you recover from physical injury"},
	...
	"fatigueRecover": {"name":"Stamina recovery", "desc":"Speed of recovery from exertion and fatigue"},
